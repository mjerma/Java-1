...
import hr.algebra.EditMoviesPanel;
...
public class MovieTableModel extends AbstractTableModel{
    ...
    private static final String[] COLUMN_NAMES = {"Id", "Title", "Published date", "Description", "Original title", "Directors", "Actors", "Duration", "Genre", "Picture path", "Link", "Start date"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 5:
                return EditMoviesPanel.personListToString(movies.get(rowIndex).getDirectors());
            case 6:
                return EditMoviesPanel.personListToString(movies.get(rowIndex).getActors());
            case 7:
